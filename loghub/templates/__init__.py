...
CHANGELOG_GROUPS_TEMPLATE_PATH = os.path.join(HERE, 'changelog_label_groups.txt')
CHANGELOG_ISSUE_GROUPS_TEMPLATE_PATH = os.path.join(HERE, 'changelog_issue_groups.txt')
CHANGELOG_PR_GROUPS_TEMPLATE_PATH = os.path.join(HERE, 'changelog_pr_groups.txt')
...
RELEASE_ISSUE_GROUPS_TEMPLATE_PATH = os.path.join(HERE, 'release_issue_groups.txt')
